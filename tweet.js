...
pre = [
    "I like to" + adjs.pick().word + ".",
    "There is a " + singularize(nouns.pick().word) + " outside my house.", 
    "What a " + adjs.pick().word + singularize(nouns.pick().word),
    "This is a verb: " + verbs.pick().word,
    "This is a  noun" + singularize(nouns.pick().word),
    "This is an adjective:  " + adjs.pick().word
    // etc.			
];
